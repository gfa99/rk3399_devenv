...
#define GATT_READ_ALLOWED           (GATT_PERM_READ | GATT_PERM_READ_ENCRYPTED  \
...
#define GATT_READ_ENCRYPTED_REQUIRED   (GATT_PERM_READ_ENCRYPTED    \
                                      | GATT_PERM_READ_ENC_MITM)


#define GATT_WRITE_ALLOWED          (GATT_PERM_WRITE            \
                                   | GATT_PERM_WRITE_ENCRYPTED  \
                                   | GATT_PERM_WRITE_ENC_MITM   \
                                   | GATT_PERM_WRITE_SIGNED     \
                                   | GATT_PERM_WRITE_SIGNED_MITM)

#define GATT_WRITE_AUTH_REQUIRED    (GATT_PERM_WRITE_ENCRYPTED  \
                                   | GATT_PERM_WRITE_SIGNED)

#define GATT_WRITE_MITM_REQUIRED    (GATT_PERM_WRITE_ENC_MITM   \
                                   | GATT_PERM_WRITE_SIGNED_MITM)

#define GATT_WRITE_ENCRYPTED_PERM   (GATT_PERM_WRITE_ENCRYPTED  \
                                   | GATT_PERM_WRITE_ENC_MITM)

#define GATT_WRITE_SIGNED_PERM      (GATT_PERM_WRITE_SIGNED     \
                                   | GATT_PERM_WRITE_SIGNED_MITM)
...
typedef union
{
    ...
    UINT8           client_read_index; /* only used for sequential reading
                                          client srv chg info */
} tGATTS_SRV_CHG_REQ;
...
GATT_API extern UINT16 GATTS_CreateService (tGATT_IF gatt_if, tBT_UUID *p_svc_uuid,
                                            UINT16 svc_inst, UINT16 num_handles,
                                            BOOLEAN is_pri);
...
**
*******************************************************************************/
GATT_API extern UINT16 GATTS_AddCharacteristic (UINT16 service_handle,
                                                tBT_UUID *char_uuid,
                                                tGATT_PERM perm,
...
**
*******************************************************************************/
GATT_API extern  tGATT_IF GATT_Register (tBT_UUID *p_app_uuid128,
