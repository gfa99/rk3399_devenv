...
#else
static void count_a2dp_packet_timeout(struct timer_list *timer);
static void count_pan_packet_timeout(struct timer_list *timer);
static void count_hogp_packet_timeout(struct timer_list *timer);
#endif
...
#else
static void polling_bt_info(struct timer_list *timer)
#endif
{
	uint8_t temp_cmd[1];
