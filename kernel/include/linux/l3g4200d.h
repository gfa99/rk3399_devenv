...
#define L3G4200D_IOCTL_SET_DELAY _IOW(L3G4200D_IOCTL_BASE, 0, char)
#define L3G4200D_IOCTL_GET_DELAY _IOR(L3G4200D_IOCTL_BASE, 1, char)
#define L3G4200D_IOCTL_GET_ENABLE _IOW(L3G4200D_IOCTL_BASE, 255, unsigned int)
#define L3G4200D_IOCTL_SET_ENABLE _IOR(L3G4200D_IOCTL_BASE, 254, unsigned int)
